        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="img/camp1a.jpg" class="img-fluid" alt="Imagen 1"></td>
                            <td><img src="img/camp2a.jpg" class="img-fluid" alt="Imagen 2"></td>
                            <td><img src="img/camp3a.jpg" class="img-fluid" alt="Imagen 3"></td>
                            <td><img src="img/camp4a.jpg" class="img-fluid" alt="Imagen 4"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
