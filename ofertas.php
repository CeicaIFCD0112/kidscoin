        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="img/wek1.jpg" class="img-fluid" alt="Imagen 1"></td>
                            <td><img src="img/wek1.jpg" class="img-fluid" alt="Imagen 2"></td>
                            <td><img src="img/wek1.jpg" class="img-fluid" alt="Imagen 3"></td>
                            <td><img src="img/wek1.jpg" class="img-fluid" alt="Imagen 4"></td>
                            <td><img src="img/trk1.jpg" class="img-fluid" alt="Imagen 4"></td>
                            <td><img src="img/cann1.jpg" class="img-fluid" alt="Imagen 4"></td>
                        </tr>
                    </tbody>
                    <thead>
                        <tr>
